public class Main {
    public static void main(String[] args) {
        ...
        Slytherin drako = new Slytherin("Драко ","Малфой",89, 78, 79,77,70,99);
        Slytherin gregori = new Slytherin("Грэхэм  ","Монтегю",78, 80, 68,87,50,65);
        Slytherin grehem = new Slytherin("Грегори  ","Гойл",50, 67, 47,89,78,56);
